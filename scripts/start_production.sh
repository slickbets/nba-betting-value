...
0 14 * * * root cd /app && /usr/local/bin/python scripts/daily_update.py >> /data/daily_update.log 2>&1
0 15 * * * root cd /app && /usr/local/bin/python scripts/daily_update.py >> /data/daily_update.log 2>&1
CRON
